<script type="text/javascript">
        ...
        var data = {
            labels : [<?php for($i=1; $i<count($diaVisits); $i++) echo $i.', '; ?>],
            datasets : [
                {
                    label: "First dataset",
                    ...
                    data: [<?php for($i=0; $i<count($diaVisits); $i++) echo $diaVisits[$i].', '; ?>]
                },
                {
                    ...
                    data: [<?php for($i=0; $i<count($diaVisits); $i++) echo $diaPageviews[$i].', '; ?>]
                }
            ]
        };
            ...
            datasets: [
                {
                    ...
                    data: [<?php for($i=0; $i<count($mes); $i++) echo $mesViews[$i].', '; ?>]
                }
            ]
        };
        ...
        */
        var radarChartData = {
            labels: [<?php for($i=0; $i<count($navegador); $i++) echo '"'.$navegador[$i].'", '; ?>],
            datasets: [
                {
                    label: "First dataset",
                    ...
                    data: [<?php for($i=0; $i<count($navegador); $i++) echo $navegadorViews[$i].', '; ?>]
                }
            ],
        };
        ...
        */
        var lineChartData = {
            labels : [<?php for($i=0; $i<count($pais); $i++) echo '"'.$pais[$i].'", '; ?>],
            datasets : [
                {
                    label: "My dataset",
                    ...
                    data: [<?php for($i=0; $i<count($pais); $i++) echo $paisVisits[$i].', '; ?>]
                }
            ]
